...
{
	assert(check_any_is_divisible_by_3(3,2) == true && "check_any_is_divisible_by_3");
	assert(check_any_is_divisible_by_3(7,12) == true && "check_any_is_divisible_by_3");
}

static void test_all_divisible_by_3() 
{
	assert(check_any_is_divisible_by_3(3,6) == true && "check_any_is_divisible_by_3");
	assert(check_any_is_divisible_by_3(6,9) == true && "check_any_is_divisible_by_3");
}
