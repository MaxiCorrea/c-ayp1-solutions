...
{
	assert(is_multiple_of_2(2) == true && "is_multiple_of_2");
	assert(is_multiple_of_2(4) == true && "is_multiple_of_2");
	assert(is_multiple_of_2(6) == true && "is_multiple_of_2");
	assert(is_multiple_of_2(8) == true && "is_multiple_of_2");	
}
